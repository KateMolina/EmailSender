...
namespace EmailSender
{
    ...
    partial void DeleteEmail(Email instance);
		...
		public EmailsDataContext() : 
				base(global::EmailSender.Properties.Settings.Default.MailsAndSendersConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnEmailColChanging(string value);
    ...
    partial void OnNameChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_EmailCol", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
		public string EmailCol
		{
			get
			{
				return this._EmailCol;
			}
			set
			{
				if ((this._EmailCol != value))
				{
					this.OnEmailColChanging(value);
					this.SendPropertyChanging();
					this._EmailCol = value;
					this.SendPropertyChanged("EmailCol");
					this.OnEmailColChanged();
				}
			}
		}
